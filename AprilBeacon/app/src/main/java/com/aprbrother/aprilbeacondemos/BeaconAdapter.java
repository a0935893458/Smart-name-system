...
public class BeaconAdapter extends BaseAdapter {
	...
	private void bind(Beacon beacon, View view) {
		...
		holder.measuredPowerTextView.setText("Distance: "
				+ beacon.getDistance() + " m");

		if (beacon.getDistance() <= 10)
		{
			BeaconList.myl.one2ten = 1;
			Log.i("TAG", "distance match");
		}
		else
		{
			BeaconList.myl.one2ten = 0;
			Log.i("TAG", "distance unmatch");
		}
