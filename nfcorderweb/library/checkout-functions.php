...
function saveOrder()
{
	...
	if (checkRequiredPost($requiredField)) {
		...
		$sql = "INSERT INTO tbl_order(od_date, od_last_update, od_shipping_first_name, od_shipping_last_name, od_shipping_address1, 
									  ...
									  od_payment_phone, od_payment_state, od_payment_city, od_payment_postal_code, user_id)
                VALUES (NOW(), NOW(), '$hidShippingFirstName', '$hidShippingLastName', '$hidShippingAddress1', 
						...
						'$hidPaymentAddress2', '$hidPaymentPhone', '$hidPaymentState', '$hidPaymentCity', '$hidPaymentPostalCode', '$user')";
		$result = dbQuery($sql);
