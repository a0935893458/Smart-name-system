...
if ($numProduct > 0 ) {
	...
	while ($row = dbFetchAssoc($result)) {
		...
		echo "<td width=\"$columnWidth%\" align=\"center\"><a href=\"" . $_SERVER['PHP_SELF'] . "?c=$catId&p=$pd_id" . "\"><img src=\"$pd_thumbnail\" border=\"0\"><br>$pd_name</a><br>價格 : $pd_price";
...
?>
	<tr><td width="100%" align="center" valign="center">無產品分類</td></tr>
<?php	
}	
?>
</table>
